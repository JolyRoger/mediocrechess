...
public class Move implements Definitions {
	 ...
	 */
	public synchronized static int pieceMoving(int move) {
	 ...
	 * @return int To-index
	 */
	public synchronized static int toIndex(int move) {
	 ...
	 */
	public synchronized static int fromIndex(int move) {
	 ...
	 */
	public synchronized static int capture(int move) {
	 ...
	 */
	public synchronized static int moveType(int move) {
	 ...
	 */
	public synchronized static int orderingValue(int move) {
	 ...
	 */
	public synchronized static int setOrderingValue(int move, int value) {
	 ...
	 */
	public synchronized static int createMove(int pieceMoving, int fromIndex, int toIndex,
	 ...
	 */
	public synchronized static String notation(int move) {
	 ...
	 */
	public synchronized static String inputNotation(int move) {
